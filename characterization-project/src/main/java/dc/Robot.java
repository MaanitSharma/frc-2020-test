...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("l_encoder_pos", leftEncoderPosition.get() * -1);
    SmartDashboard.putNumber("l_encoder_rate", leftEncoderRate.get());
    SmartDashboard.putNumber("r_encoder_pos", rightEncoderPosition.get());
    SmartDashboard.putNumber("r_encoder_rate", rightEncoderRate.get());
    SmartDashboard.putNumber("g_gyro_angle", gyro.getAngle());
  }
  ...
  public void autonomousPeriodic() {
    ...
    double leftPosition = leftEncoderPosition.get() * -1; //changed
    ...
    double gyroAngleRadians = gyro.getAngle();
